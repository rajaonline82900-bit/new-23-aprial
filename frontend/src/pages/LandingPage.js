          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="max-w-md mx-auto mb-12 space-y-4">
              <div className="text-center mb-6">
                <h2 className="text-white text-xl font-bold">नया अकाउंट बनाएं</h2>
                <p className="text-gray-400 text-sm mt-1">अपना पसंदीदा तरीका चुनें</p>
              </div>

              {/* OTP Signup */}
              <Link to="/signup" state={{ method: 'otp' }} data-testid="landing-otp-signup">
                <button className="w-full p-4 rounded-xl bg-[#141418] border border-white/10 hover:border-[#D4AF37]/50 transition-all flex items-center gap-4 group">
              ...
              <button
                ...
                data-testid="landing-google-signup"
                className="w-full p-4 rounded-xl bg-[#141418] border border-white/10 hover:border-[#D4AF37]/50 transition-all flex items-center gap-4 group"
              >
              ...
              <p className="text-center text-gray-500 text-sm">
                पहले से अकाउंट है? <Link to="/login" className="text-[#D4AF37] hover:text-[#FDE047] font-medium">लॉगिन करें</Link>
              </p>
            </div>
