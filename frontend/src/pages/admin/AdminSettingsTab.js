        ...
        <div className="border-t border-white/10 pt-4">
          ...
          <div className="space-y-3">
            <div>
              ...
              <Input type="text" placeholder="जैसे: Shiv Shakti Club - नया अपडेट!" value={pushTitle} onChange={(e) => setPushTitle(e.target.value)} data-testid="push-title-input" className="bg-[#0A0A0C] border-white/10 text-white" />
            </div>
            <div>
