  ...
  return (
    <Card className="bg-[#141418] border-white/10">
      <CardHeader>
        ...
        <CardDescription className="text-gray-400">सभी सफल जमा की सूची</CardDescription>
      </CardHeader>
      <CardContent>
        {deposits.length === 0 ? (
          <div className="text-center py-8"><p className="text-gray-400">कोई जमा नहीं मिला</p></div>
        ) : (
