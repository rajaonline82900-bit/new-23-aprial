                ...
                <div key={g.game_id} className={`flex items-center justify-between p-3 rounded-lg border ${g.declared ? 'bg-emerald-500/5 border-emerald-500/20' : 'bg-[#0A0A0C] border-white/5'}`} data-testid={`result-status-${g.game_id}`}>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-xs">{g.start_time} - {g.end_time} | बेट्स: {g.total_bets}</p>
                    </div>
                  </div>
                  <div className="text-right">
                    {g.declared ? (
                      ...
                      <span className="text-gray-400 text-sm">{g.pending_bets > 0 ? `${g.pending_bets} pending` : 'कोई बेट नहीं'}</span>
                    )}
                  </div>
                </div>
              ))}
      ...
      <Card className="bg-[#141418] border-white/10">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="border-t border-white/10 pt-4 mt-4">
            ...
            <p className="text-gray-400 text-xs mt-3">रिजल्ट रिवर्स: रिजल्ट हटाएगा, जीती राशि काटेगा, बेट्स pending करेगा। बेट रिवर्स: बेट राशि user को वापस करेगा।</p>
          </div>
        </CardContent>
      </Card>
    </>
