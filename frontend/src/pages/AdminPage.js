    ...
    <div className="min-h-screen bg-[#0A0A0C]">
      ...
      <main className="container mx-auto px-4 py-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <div className="mb-4 -mx-3 px-3 overflow-x-auto scrollbar-hide">
            ...
            >
              {[
                ...
                { value: 'fake_ticker', label: 'Ticker Fake' },
          ...
          <TabsContent value="fake_ticker"><AdminFakeTickerTab /></TabsContent>
          ...
          <TabsContent value="winners"><AdminWinnersTab games={games} /></TabsContent>
