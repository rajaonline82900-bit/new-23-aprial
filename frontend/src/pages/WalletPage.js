...
const WalletPage = () => {
  ...
  const getStatusBadge = (status) => {
    switch (status) {
      ...
      case 'failed':
        return <Badge className="bg-red-500/20 text-red-400"><XCircle className="w-3 h-3 mr-1" /> विफल</Badge>;
      default:
          ...
          <CardContent className="p-6">
            ...
            <div className="grid grid-cols-2 gap-4 mt-6">
              ...
              <Button
                ...
                variant="outline"
                className="h-12 border-white/20 text-white hover:bg-[#0A0A0C]/10"
              >
